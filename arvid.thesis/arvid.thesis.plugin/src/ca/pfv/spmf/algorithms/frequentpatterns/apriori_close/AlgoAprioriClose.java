...
public class AlgoAprioriClose {
	 ...
	 * @param minsup  a minimum support value (absolute)
	 ...
	 */
	public Itemsets runAlgorithm(int minsup, InputStream input, String output) throws IOException {
		...
		this.minsupRelative = minsup; // (int) Math.ceil(minsup * databaseSize);
